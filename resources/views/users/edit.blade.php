...
@section('title') User Update | @env('APP_NAME') @endenv @stop()
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="row  ">
                    <div class="col-3"></div>
                    <div class="col-6">
                        <h2 class="mt-5 mb-4">Update Here</h2>
                        <form action={{ route('users.update', ['user' => $user->id]) }} method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <img src={{url('/images/' . $user->profile_image)}} alt="Alt" height="100" width="100" class="img-rounded rounded" >
